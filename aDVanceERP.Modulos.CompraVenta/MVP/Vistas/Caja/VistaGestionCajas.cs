...
namespace aDVanceERP.Modulos.CompraVenta.MVP.Vistas.Caja {
    public partial class VistaGestionCajas : Form, IVistaGestionCajas {
        ...
        public bool HabilitarBtnCierreCajaRegistradora {
            get => btnCerrarCajaRegistradora.Visible;
            set => btnCerrarCajaRegistradora.Visible = value;
        }
        ...
        public event EventHandler? CerrarCaja;
        ...
        public void Inicializar() {
            ...
            btnCerrarCajaRegistradora.Click += delegate (object? sender, EventArgs e) {
                btnCerrarCajaRegistradora.Hide();
                CerrarCaja?.Invoke(sender, e);
            };
        ...
        private void VerificarPermisos() {
            btnRegistrar.Enabled = (UtilesCuentaUsuario.UsuarioAutenticado?.Administrador ?? false)
                || UtilesCuentaUsuario.PermisosUsuario.ContienePermisoExacto("MOD_COMPRAVENTA_CAJA_ABRIR")
                || UtilesCuentaUsuario.PermisosUsuario.ContienePermisoExacto("MOD_COMPRAVENTA_CAJA_CERRAR")
        ...
        public void Restaurar() {
            ...
            PaginaActual = 1;
            PaginasTotales = 1;
            HabilitarBtnCierreCajaRegistradora = false;
