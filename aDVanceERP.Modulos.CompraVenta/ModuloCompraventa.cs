namespace aDVanceERP.Modulos.CompraVenta {
    public static class ModuloCompraventa {
        public const string Nombre = "MOD_COMPRAVENTA";
        ...
        public static readonly string[] Permisos = {
            ...
            "MOD_COMPRAVENTA_CAJA_TODOS",
            "MOD_COMPRAVENTA_CAJA_ABRIR",
            "MOD_COMPRAVENTA_CAJA_CERRAR",
            "MOD_COMPRAVENTA_CAJA_ELIMINAR"
        };
    }
}
