...
namespace Manigest.Modulos.Ventas.MVP.Vistas.Menu {
    partial class VistaMenuVentas {
        ...
        private void InitializeComponent() {
            ...
            btnVentaArticulos.BackColor = Color.FromArgb(  243,   243,   243);
            btnVentaArticulos.ButtonMode = Guna.UI2.WinForms.Enums.ButtonMode.RadioButton;
            btnVentaArticulos.CheckedState.FillColor = Color.FromArgb(  248,   244,   242);
            ...
            btnVentaArticulos.CustomImages.ImageOffset = new Point(0, 30);
            ...
            btnVentaArticulos.FillColor = Color.FromArgb(  243,   243,   243);
            btnVentaArticulos.Font = new Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point);
            btnVentaArticulos.ForeColor = Color.FromArgb(  40,   37,   35);
