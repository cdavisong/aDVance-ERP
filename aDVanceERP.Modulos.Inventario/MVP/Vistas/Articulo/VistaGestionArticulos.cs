...
public partial class VistaGestionArticulos : Form, IVistaGestionArticulos {
    ...
    public CriterioBusquedaArticulo CriterioBusqueda {
        get => fieldCriterioBusqueda.SelectedIndex >= 0
            ? (CriterioBusquedaArticulo)fieldCriterioBusqueda.SelectedIndex
            : default;
    ...
    public void CargarCriteriosBusqueda(object[] criteriosBusqueda) {
        ...
        fieldCriterioBusqueda.SelectedIndexChanged += delegate {
            ...
            BuscarDatos?.Invoke(new object[] { CriterioBusqueda, new[] { NombreAlmacen, DatoBusqueda } },
                EventArgs.Empty);
    ...
    private async void ActualizarMontoInversion() {
        ValorBrutoInversion =
            (await UtilesArticulo.ObtenerMontoInvertidoEnArticulos(await UtilesAlmacen.ObtenerIdAlmacen(NombreAlmacen)))
