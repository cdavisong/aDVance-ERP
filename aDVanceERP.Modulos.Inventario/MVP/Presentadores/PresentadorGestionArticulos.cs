...
public class PresentadorGestionArticulos : PresentadorGestionBase<PresentadorTuplaArticulo, IVistaGestionArticulos,
    IVistaTuplaArticulo, Articulo, DatosArticulo, CriterioBusquedaArticulo> {
    ...
    protected override PresentadorTuplaArticulo ObtenerValoresTupla(Articulo objeto) {
        ...
        presentadorTupla.Vista.Stock = string.IsNullOrEmpty(objeto.Stock)
            ? UtilesArticulo.ObtenerStockTotalArticulo(objeto.Id).Result
