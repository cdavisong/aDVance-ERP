...
public class DatosArticuloAlmacen : RepositorioDatosBase<ArticuloAlmacen, CriterioBusquedaArticuloAlmacen>,
    IRepositorioArticuloAlmacen {
    ...
    public override string ComandoAdicionar(ArticuloAlmacen objeto) {
        return
            $"INSERT INTO adv__articulo_almacen (id_articulo, id_almacen, stock) VALUES ('{objeto.IdArticulo}', '{objeto.IdAlmacen}', '{objeto.Stock}');";
    }

    public override string ComandoEditar(ArticuloAlmacen objeto) {
        return
            $"UPDATE adv__articulo_almacen SET id_articulo='{objeto.IdArticulo}', id_almacen='{objeto.IdAlmacen}', stock='{objeto.Stock}' WHERE id_articulo_almacen={objeto.Id};";
    }
    ...
    public override ArticuloAlmacen ObtenerObjetoDataReader(MySqlDataReader lectorDatos) {
        return new ArticuloAlmacen(
            lectorDatos.GetInt32(lectorDatos.GetOrdinal("id_articulo_almacen")),
