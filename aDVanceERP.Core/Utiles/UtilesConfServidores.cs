...
public static class UtilesConfServidores {
    ...
    public static string ObtenerStringConfServidorMySQL() {
        ...
        if (string.IsNullOrEmpty(stringConexion)) {
            ...
            VariablesGlobales.StringConexionBaseDatos =
                $"server = {confServidorMySQL.ElementAt(0)}; user id = {confServidorMySQL.ElementAt(2)}; password = {confServidorMySQL.ElementAt(3)}; database = {confServidorMySQL.ElementAt(1)}; pooling = false;";
