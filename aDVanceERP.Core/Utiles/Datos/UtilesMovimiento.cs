    ...
    public static class UtilesMovimiento {
        public static long ObtenerIdTipoMovimiento(string nombreTipoMovimiento) {
            ...
            using (var conexion = new MySqlConnection(UtilesConfServidores.ObtenerStringConfServidorMySQL())) {
                ...
                using (var comando = conexion.CreateCommand()) {
                    comando.CommandText = $"SELECT id_tipo_movimiento FROM adv__tipo_movimiento WHERE LOWER(nombre) LIKE LOWER('%{nombreTipoMovimiento}%');";
        ...
        public static string? ObtenerNombreTipoMovimiento(long idTipoMovimiento) {
            ...
            using (var conexion = new MySqlConnection(UtilesConfServidores.ObtenerStringConfServidorMySQL())) {
                ...
                using (var comando = conexion.CreateCommand()) {
                    comando.CommandText = $"SELECT nombre FROM adv__tipo_movimiento WHERE id_tipo_movimiento='{idTipoMovimiento}';";
        ...
        public static string ObtenerEfectoTipoMovimiento(long idTipoMovimiento) {
            ...
            using (var conexion = new MySqlConnection(UtilesConfServidores.ObtenerStringConfServidorMySQL())) {
                ...
                using (var comando = conexion.CreateCommand()) {
                    comando.CommandText = $"SELECT efecto FROM adv__tipo_movimiento WHERE id_tipo_movimiento='{idTipoMovimiento}';";
