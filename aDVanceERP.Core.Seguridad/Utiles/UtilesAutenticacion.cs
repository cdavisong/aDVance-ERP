...
namespace aDVanceERP.Core.Seguridad.Utiles {
    public static class UtilesAutenticacion {
        ...
        static string[] Scopes = { Oauth2Service.Scope.UserinfoProfile, Oauth2Service.Scope.UserinfoEmail };
        static string ApplicationName = "aDVanceERP.Desktop";
        ...
        public static async Task<string> ObtenerNombreUsuario() {
            ...
            Userinfo me = await service.Userinfo.Get().ExecuteAsync();
            return me.Name;
        }
