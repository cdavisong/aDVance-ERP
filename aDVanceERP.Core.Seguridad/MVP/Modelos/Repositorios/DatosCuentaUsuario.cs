...
public class DatosCuentaUsuario : RepoBase<CuentaUsuario, CriterioBusquedaCuentaUsuario> {
    ...
    public override string GenerarQueryObtener(CriterioBusquedaCuentaUsuario criterio, string dato) {
        string comando;
        switch (criterio) {
