...
namespace aDVanceERP.Core.Seguridad.MVP.Modelos.Repositorios {
    public class DatosPermisoRolUsuario : RepositorioDatosBase<PermisoRolUsuario, CriterioBusquedaPermisoRolUsuario>, IRepositorioPermisoRolUsuario {
        ...
        public override PermisoRolUsuario ObtenerObjetoDataReader(MySqlDataReader lectorDatos) {
            return new PermisoRolUsuario(
                id: lectorDatos.GetInt64("id_rol_permiso"),
                idRolUsuario: lectorDatos.GetInt64("id_rol_usuario"),
                idPermiso: lectorDatos.GetInt64("id_permiso")
            );
        }
