...
namespace Manigest.Modulos.Inventario.MVP.Vistas.Movimiento {
    partial class VistaRegistroMovimiento {
        ...
        private void InitializeComponent() {
            ...
            layoutVista.Controls.Add(layoutTituloMotivoCantidad, 2, 10);
            layoutVista.Controls.Add(layoutMotivoCantidad, 2, 11);
            layoutVista.Controls.Add(layoutTituloAlmacenes, 2, 7);
            layoutVista.Controls.Add(layoutAlmacenes, 2, 8);
            ...
            layoutTituloMotivoCantidad.Location = new Point(50, 310);
            ...
            layoutMotivoCantidad.Controls.Add(fieldMotivo, 0, 0);
            layoutMotivoCantidad.Dock = DockStyle.Fill;
            layoutMotivoCantidad.Location = new Point(50, 345);
            ...
            fieldCantidadMovida.BorderColor = Color.FromArgb(  217,   211,   204);
            ...
            fieldCantidadMovida.DisabledState.BorderColor = Color.FromArgb(  208,   208,   208);
            fieldCantidadMovida.DisabledState.FillColor = Color.FromArgb(  226,   226,   226);
            fieldCantidadMovida.DisabledState.ForeColor = Color.FromArgb(  138,   138,   138);
            fieldCantidadMovida.DisabledState.PlaceholderForeColor = Color.FromArgb(  138,   138,   138);
            ...
            fieldCantidadMovida.PlaceholderForeColor = Color.FromArgb(  115,   109,   106);
            ...
            fieldMotivo.BackColor = Color.Transparent;
            fieldMotivo.BorderColor = Color.FromArgb(  217,   211,   204);
            fieldMotivo.BorderRadius = 16;
            fieldMotivo.CustomizableEdges = customizableEdges7;
            fieldMotivo.DrawMode = DrawMode.OwnerDrawFixed;
            fieldMotivo.DropDownStyle = ComboBoxStyle.DropDownList;
            ...
            fieldMotivo.Size = new Size(198, 35);
            fieldMotivo.TabIndex = 32;
            fieldMotivo.TextOffset = new Point(10, 0);
            // 
            ...
            layoutTituloAlmacenes.Location = new Point(50, 220);
            ...
            layoutAlmacenes.Location = new Point(50, 255);
            ...
            fieldNombreAlmacenDestino.BorderColor = Color.FromArgb(  217,   211,   204);
            ...
            fieldNombreArticulo.CustomizableEdges = customizableEdges13;
            ...
            fieldNombreArticulo.ShadowDecoration.CustomizableEdges = customizableEdges14;
        ...
        private Guna2ComboBox fieldMotivo;
