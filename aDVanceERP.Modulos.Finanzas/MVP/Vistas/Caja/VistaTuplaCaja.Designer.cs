...
namespace aDVanceERP.Modulos.Finanzas.MVP.Vistas.Caja {
    partial class VistaTuplaCaja {
        ...
        private void InitializeComponent() {
            ...
            layoutVista.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 40F));
            layoutVista.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 40F));
            layoutVista.Controls.Add(fieldNombreUsuario, 8, 0);
            layoutVista.Controls.Add(fieldFechaCierre, 6, 0);
            layoutVista.Controls.Add(simboloPeso2, 5, 0);
            layoutVista.Controls.Add(fieldSaldoActual, 4, 0);
            ...
            layoutVista.Controls.Add(btnDescargarInforme, 10, 0);
