...
namespace aDVanceERP.Modulos.Contactos.MVP.Modelos.Repositorios {
    public class DatosProveedor : RepositorioDatosBase<Proveedor, CriterioBusquedaProveedor>, IRepositorioProveedor {
        ...
        public override string ComandoAdicionar(Proveedor objeto) {
            return $"INSERT INTO adv__proveedor (razon_social, nit, id_contacto) VALUES ('{objeto.RazonSocial}', '{objeto.NumeroIdentificacionTributaria}', '{objeto.IdContactoRepresentante}');";
        }

        public override string ComandoEditar(Proveedor objeto) {
            return $"UPDATE adv__proveedor SET razon_social='{objeto.RazonSocial}', nit='{objeto.NumeroIdentificacionTributaria}', id_contacto='{objeto.IdContactoRepresentante}' WHERE id_proveedor={objeto.Id};";
        }
