...
public class DatosContacto : RepoBase<Contacto, CriterioBusquedaContacto> {
    ...
    public override string GenerarQueryObtener(CriterioBusquedaContacto criterio, string dato) {
