...
namespace aDVanceERP.Modulos.Contactos.MVP.Vistas.Proveedor {
    public partial class VistaGestionProveedores : Form, IVistaGestionProveedores {
        ...
        public CriterioBusquedaProveedor CriterioBusqueda {
            get => fieldCriterioBusqueda.SelectedIndex >= 0 ? (CriterioBusquedaProveedor) fieldCriterioBusqueda.SelectedIndex : default;
        ...
        private void VerificarPermisos() {
            btnRegistrar.Enabled = (UtilesCuentaUsuario.UsuarioAutenticado?.Administrador ?? false)
                || UtilesCuentaUsuario.PermisosUsuario.ContienePermisoExacto("MOD_CONTACTO_PROVEEDORES_ADICIONAR")
