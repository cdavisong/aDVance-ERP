...
namespace aDVanceERP.Core.ClienteMySQL.MVP.Vistas {
    partial class VistaConfServidorMySQL {
        ...
        private void InitializeComponent() {
            ...
            fieldBaseDatos.BorderColor = Color.Gainsboro;
            ...
            fieldBaseDatos.DisabledState.BorderColor = Color.Gainsboro;
            fieldBaseDatos.DisabledState.BorderColor = Color.White;
            fieldBaseDatos.DisabledState.ForeColor = Color.DimGray;
            fieldBaseDatos.DisabledState.PlaceholderForeColor = Color.DimGray;
            fieldBaseDatos.Dock = DockStyle.Fill;
            fieldBaseDatos.FillColor = Color.White;
            fieldBaseDatos.FocusedState.BorderColor = Color.SandyBrown;
            fieldBaseDatos.Font = new Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point);
            fieldBaseDatos.ForeColor = Color.Black;
            fieldBaseDatos.HoverState.BorderColor = Color.SandyBrown;
            ...
            fieldBaseDatos.PlaceholderForeColor = Color.DimGray;
