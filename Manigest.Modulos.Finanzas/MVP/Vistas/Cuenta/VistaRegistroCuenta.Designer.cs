...
namespace Manigest.Modulos.Finanzas.MVP.Vistas.Cuenta {
    partial class VistaRegistroCuenta {
        /// <summary>
        ...
        private void InitializeComponent() {
            ...
            ComponentResourceManager resources = new ComponentResourceManager(typeof(VistaRegistroCuenta));
            ...
            fieldNombrePropietario.BorderColor = Color.FromArgb(  217,   211,   204);
            ...
            fieldNombrePropietario.FillColor = Color.FromArgb(  254,   254,   253);
            fieldNombrePropietario.FocusedColor = Color.FromArgb(  2,   52,   107);
            fieldNombrePropietario.FocusedState.BorderColor = Color.FromArgb(  2,   52,   107);
            fieldNombrePropietario.Font = new Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point);
            fieldNombrePropietario.ForeColor = Color.FromArgb(  40,   37,   35);
            ...
            fieldTituloNombrePropietario.ForeColor = Color.FromArgb(  115,   109,   106);
            ...
            fieldAlias.DisabledState.BorderColor = Color.FromArgb(  208,   208,   208);
            fieldAlias.DisabledState.FillColor = Color.FromArgb(  226,   226,   226);
            fieldAlias.DisabledState.ForeColor = Color.FromArgb(  138,   138,   138);
            fieldAlias.DisabledState.PlaceholderForeColor = Color.FromArgb(  138,   138,   138);
            ...
            fieldAlias.HoverState.BorderColor = Color.FromArgb(  94,   148,   255);
            ...
            fieldAlias.PlaceholderForeColor = Color.FromArgb(  115,   109,   106);
            ...
            fieldTipoMoneda.BorderColor = Color.FromArgb(  217,   211,   204);
            ...
            fieldTipoMoneda.FillColor = Color.FromArgb(  254,   254,   253);
            fieldTipoMoneda.FocusedColor = Color.FromArgb(  2,   52,   107);
            fieldTipoMoneda.FocusedState.BorderColor = Color.FromArgb(  2,   52,   107);
            fieldTipoMoneda.Font = new Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point);
            fieldTipoMoneda.ForeColor = Color.FromArgb(  40,   37,   35);
            ...
            fieldNumeroCuenta.BorderColor = Color.FromArgb(  217,   211,   204);
            ...
            fieldNumeroCuenta.DisabledState.BorderColor = Color.FromArgb(  208,   208,   208);
            fieldNumeroCuenta.DisabledState.FillColor = Color.FromArgb(  226,   226,   226);
            fieldNumeroCuenta.DisabledState.ForeColor = Color.FromArgb(  138,   138,   138);
            fieldNumeroCuenta.DisabledState.PlaceholderForeColor = Color.FromArgb(  138,   138,   138);
            fieldNumeroCuenta.Dock = DockStyle.Fill;
            fieldNumeroCuenta.FillColor = Color.FromArgb(  254,   254,   253);
            fieldNumeroCuenta.FocusedState.BorderColor = Color.FromArgb(  2,   52,   107);
            fieldNumeroCuenta.Font = new Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point);
            fieldNumeroCuenta.ForeColor = Color.FromArgb(  40,   37,   35);
            fieldNumeroCuenta.HoverState.BorderColor = Color.FromArgb(  94,   148,   255);
            ...
            fieldNumeroCuenta.PlaceholderForeColor = Color.FromArgb(  115,   109,   106);
