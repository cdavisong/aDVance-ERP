...
namespace aDVanceERP.Modulos.Taller.Vistas.CostosProduccion {
    public partial class VistaGestionCostosDirectos : Form, IVistaGestionCostosProduccion {
        ...
        public FiltroBusquedaCostoProduccion CriterioBusqueda {
            get => fieldCriterioBusqueda.SelectedIndex >= 0
                ? (FiltroBusquedaCostoProduccion) fieldCriterioBusqueda.SelectedIndex
                : default;
        ...
        public void Inicializar() {
            ...
            fieldCriterioBusqueda.SelectedIndexChanged += delegate {
                if (CriterioBusqueda == FiltroBusquedaCostoProduccion.Fecha) {
                ...
                fieldDatoBusqueda.Visible = CriterioBusqueda != FiltroBusquedaCostoProduccion.Fecha &&
                                            fieldCriterioBusqueda.SelectedIndex != 0;
                fieldDatoBusquedaFecha.Visible = CriterioBusqueda == FiltroBusquedaCostoProduccion.Fecha &&
                                                 fieldCriterioBusqueda.SelectedIndex != 0;
        ...
        private void VerificarPermisos() {
            ...
            btnRegistrar.Enabled = (UtilesCuentaUsuario.UsuarioAutenticado?.Administrador ?? false)
                                   || UtilesCuentaUsuario.PermisosUsuario.ContienePermisoExacto("MOD_TALLER_COSTOS_ADICIONAR")
