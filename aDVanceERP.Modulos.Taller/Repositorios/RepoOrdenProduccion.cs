...
{
    public class RepoOrdenProduccion : RepoBase<OrdenProduccion, CriterioBusquedaOrdenProduccion> {
        ...
        public override string GenerarQueryObtener(CriterioBusquedaOrdenProduccion criterio, string dato) {
