...
namespace aDVanceERP.Core.Extension.MVP.Modelos.Repositorios {
    internal class DatosModuloAplicacion : RepositorioDatosBase<ModuloAplicacion, CriterioBusquedaModuloAplicacion>, IRepositorioModuloAplicacion {
        ...
        public override string ComandoEditar(ModuloAplicacion objeto) {
            return $"UPDATE adv__modulo_aplicacion SET nombre = '{objeto.Nombre}', version = {objeto.Version} WHERE id_modulo_aplicacion = {objeto.Id};";
        }
        ...
        public override ModuloAplicacion ObtenerObjetoDataReader(MySqlDataReader lectorDatos) {
            return new ModuloAplicacion(
                id: lectorDatos.GetInt64("id_modulo_aplicacion"),
                nombre: lectorDatos.GetString("nombre"),
                version: lectorDatos.GetString("version")
                );
        }
    }
}
