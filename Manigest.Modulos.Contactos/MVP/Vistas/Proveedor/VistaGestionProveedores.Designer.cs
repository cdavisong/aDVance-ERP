...
namespace Manigest.Modulos.Contactos.MVP.Vistas.Proveedor {
    partial class VistaGestionProveedores {
        ...
        private void InitializeComponent() {
            ...
            // fieldInformacion
            // 
            fieldInformacion.BackColor = Color.FromArgb(  248,   244,   242);
            fieldInformacion.BorderColor = Color.FromArgb(  252,   225,   205);
            ...
            fieldInformacion.FillColor = Color.FromArgb(  252,   225,   205);
            fieldInformacion.Font = new Font("Segoe UI", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            fieldInformacion.ForeColor = Color.FromArgb(  149,   132,   111);
            fieldInformacion.HoverState.BorderColor = Color.FromArgb(  252,   225,   205);
            fieldInformacion.HoverState.FillColor = Color.FromArgb(  252,   225,   205);
            fieldInformacion.ImageOffset = new Point(-5, 0);
            fieldInformacion.Location = new Point(17, 15);
            fieldInformacion.Margin = new Padding(17, 15, 0, 5);
            fieldInformacion.Name = "fieldInformacion";
            fieldInformacion.PressedColor = Color.FromArgb(  252,   225,   205);
            fieldInformacion.ShadowDecoration.CustomizableEdges = customizableEdges2;
            fieldInformacion.Size = new Size(701, 40);
            ...
            infoIcon.FillColor = Color.FromArgb(  252,   225,   205);
            infoIcon.Font = new Font("Bodoni MT", 16F, FontStyle.Bold, GraphicsUnit.Point);
            infoIcon.ForeColor = Color.FromArgb(  149,   132,   111);
