...
using Manigest.Modulos.Finanzas.MVP.Vistas.QR;
...
namespace Manigest.Desktop.MVP.Presentadores.ContenedorModulos {
    public partial class PresentadorContenedorModulos {
        ...
        private void InicializarVistaQR() {
            ...
            _qr.Vista.Coordenadas = new Point(Vista.Dimensiones.Width - _qr.Vista.Dimensiones.Width - 20, VariablesGlobales.AlturaBarraTituloPredeterminada);
